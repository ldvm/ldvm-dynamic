...
case class IterationData(givenPipelines: Seq[PartialPipeline], completedPipelines: Seq[CompletePipeline], possibleComponents: Seq[ComponentInstanceWithInputs])
